...
namespace CliCountry.Facturacion.Web.WebExterno.Facturacion
{
    ...
    public partial class AdministradorFacActividad : WebPage
    {
        ...
        protected void GrvEntidades_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case CliCountry.SAHI.Comun.Utilidades.Global.SELECCIONAR:
                    ...
                    ActivarRegistroGridView(indiceFila);
                    break;
            }
        }
        ...
        /// <summary>
        /// Método para activar un registro de la grilla.
        /// </summary>
        /// <param name="indiceFila">The indice fila.</param>
        private void ActivarRegistroGridView(int indiceFila)
        {
        ...
        private void GenerarEstadoCuenta()
        {
            if (Page.IsValid)
            {
                ...
                {
                    Session["ProcesoFactura"] = ContruirProcesoFactura(ventasSeleccionadas);
                    ActivarConceptosCobro();
                    
                    try
                    {
                        Atencion = AdministrarConcepto.ConsultarConceptos(Atencion);
        ...
        private ProcesoFactura ContruirProcesoFactura(List<int> ventasSeleccionadas)
        {
            ProcesoFactura procesoFactura = ConstruirEncabezado();
